...
public class BankGrpcClient5 {
    public static void main(String[] args) throws IOException {
        ...
        StreamObserver<Bank.ConvertCurencyRequist> fullcurrencyStraem = asyncStub.fullCurrencyStream(new StreamObserver<Bank.ConvertCurrencyResponse>() {
            @Override
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
              ...
              fullcurrencyStraem.onNext(curencyRequist);
                System.out.println("===========> counter = " + counter);
              counter++;
              if (counter == 20) {
                  fullcurrencyStraem.onCompleted();
                  timer.cancel();
              }
            }
        },1000,1000);
